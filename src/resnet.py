...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, option='A', use_bn=True):
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, use_bn=True):
        ...
        self.layer1 = self._make_layer(block, 16, num_blocks[0], stride=1, use_bn=use_bn)
        self.layer2 = self._make_layer(block, 32, num_blocks[1], stride=2, use_bn=use_bn)
        self.layer3 = self._make_layer(block, 64, num_blocks[2], stride=2, use_bn=use_bn)
